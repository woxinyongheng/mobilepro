        ...
        <div class="box">
            ...
            <div class="card orther">
                <p class="title">
                    ...
                    <img src="../../../../static/image/up.png" alt="" v-if="show2" @click="show2=!show2">
            ...
            <div class="card orther" v-if="dataInfo.assignInfo && dataInfo.assignInfo.assignTime">
                <p class="title">
                    派工信息
                    <img src="../../../../static/image/down.png" alt="" v-if="!show3" @click="show3=!show3">
            ...
            <div class="card orther" v-if="dataInfo.paymentInfo && dataInfo.paymentInfo.paymentTime">
                <p class="title">
                    挂单信息
                    <img src="../../../../static/image/down.png" alt="" v-if="!show4" @click="show4=!show4">
